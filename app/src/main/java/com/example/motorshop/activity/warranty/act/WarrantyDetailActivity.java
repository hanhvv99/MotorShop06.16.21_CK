...
//        System.out.println(staffId);
    ...
    public void getProWarrantyByBillId(Integer bill_id) {
        ...
        String UrlWarranty = "http://192.168.11.5:8080/api/motorshop/warranties/getNameProduct/bill_id?bill_id="+bill_id;
    ...
    private void create(int warrantyId, int motorId, int accessoryId) {
        ...
        String URL = "http://192.168.11.5:8080/api/motorshop/warrantyDetails";
...
//        }
    ...
    public void getDataWarrantyDetailByWarrantyID(Integer warrantyId){
        ...
        String Url = "http://192.168.11.5:8080/api/motorshop/warrantyDetails/getWarrantyDetailByWaId/warrantyId?warrantyId="+warrantyId;
        RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
        StringRequest oStringRequest = new StringRequest(
    ...
    public void callDell(int pos){
        ...
        String Url = "http://192.168.11.5:8080/api/motorshop/warrantyDetails?id="+pos;
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest oStringRequest = new StringRequest(
    ...
    public void getPriceByWaId(Integer warrantyId){
        ...
        String Url = "http://192.168.11.5:8080/api/motorshop/warrantyDetails/getPriceByWaId/warrantyId?warrantyId="+warrantyId;
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest oStringRequest = new StringRequest(
                Request.Method.GET, Url,
                new Response.Listener<String>() {
