...
public class ListProductWarrantyAdapter extends ArrayAdapter<WarrantyDetail> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ListProductWarrantyAdapter.ViewHolder viewHolder;
        if(convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_list_warranty_details,parent,false);
            viewHolder = new ListProductWarrantyAdapter.ViewHolder();
            ...
            viewHolder = (ListProductWarrantyAdapter.ViewHolder) convertView.getTag();
        }
